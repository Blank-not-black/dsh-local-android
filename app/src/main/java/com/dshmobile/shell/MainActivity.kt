...
class MainActivity : ComponentActivity() {
  ...
  private fun buildGuideView(): LinearLayout {
    ...
    // Logo + title: the fixed header of the startup/test dual-state screen.
    ...
    // Last-abnormal-exit banner (shown when a crash marker exists).
    ...
    // Extraction/update progress bar (visible only during a snapshot refresh).
    ...
    // Failure diagnostics: engine.log tail summary (for troubleshooting on the test screen).
